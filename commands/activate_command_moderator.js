const {                                           //Traducción    /     Translation
  ...
  Command_activate_command_moderator_0,
  Command_activate_command_moderator_1,
  Command_activate_command_moderator_2
} = require("../languages/Config_Language.js");   //Traducción    /     Translation

module.exports = {
  name: `${Command_activate_command_moderator_0}`,
  cooldown: 3,
  aliases: [`${Command_activate_command_moderator_1}`],
  description: `${Command_activate_command_moderator_2}`,
  execute(message, args, client, GENERAL_ENABLED) {
    ...
    if (user_boolean.admin_user ) {         //Returns Boolean: Is it administrator? (True or False   /      Devuelve booleano: ¿es administrador? (True o False
      ...
      if (GENERAL_ENABLED.command_MODERATOR_Enabled) {
        GENERAL_ENABLED.command_MODERATOR_Enabled= false
        translator_text1 =`${Command_activate_command_0} ${Command_activate_command_moderator_0}`
        translator_text2 =`${Command_activate_command_1}`
      } else {
        GENERAL_ENABLED.command_MODERATOR_Enabled= true
        translator_text1 =`${Command_activate_command_2} ${Command_activate_command_moderator_0}`
