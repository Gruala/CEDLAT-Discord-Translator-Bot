const {                                           //Traducción    /     Translation
  ...
  Command_activate_black_list_0,
  Command_activate_black_list_1,
  Command_activate_black_list_2
} = require("../languages/Config_Language.js");   //Traducción    /     Translation

module.exports = {
  name: `${Command_activate_black_list_0}`,
  cooldown: 3,
  aliases: [`${Command_activate_black_list_1}`],
  description: `${Command_activate_black_list_2}`,
  execute(message, args, client, GENERAL_ENABLED) {
    ...
    if (user_boolean.admin_moderator_user ) {         //Returns Boolean: Is it administrator? (True or False   /      Devuelve booleano: ¿es administrador? (True o False
      ...
      if (GENERAL_ENABLED.command_BLACK_Enabled) {
        GENERAL_ENABLED.command_BLACK_Enabled= false
        translator_text1 =`${Command_activate_command_0} ${Command_activate_black_list_0}`
        translator_text2 =`${Command_activate_command_1}`
      } else {
        GENERAL_ENABLED.command_BLACK_Enabled= true
        translator_text1 =`${Command_activate_command_2} ${Command_activate_black_list_0}`
